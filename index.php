<?php get_header();?>
		<section class="banner">
			<div class="container position-relative">
					...
					<div class="col-12">
						<div class="content">
							<div class="entry-title">
								<h1 class="title animated fadeInLeft">Spend Away Your Debt.</h1>
							</div>

							<p class="animated fadeInLeft delay-1s">Payoff your debt by leveraging micropayments through every day transactions!</p>

							<div class="button-group d-flex align-items-center">
								<a href="#" class="btn animated fadeInLeft delay-1s">Get the App</a>
				...
				<div class="background animated fadeInUp delay-1s">
					<img src="<?php echo get_theme_file_uri();?>/assets/images/spendebt-mobile.png" class="img-fluid" alt="">
				</div>
			</div>
		</section><!-- /banner -->
		...
		<div id="primary" class="content-area">
			...
			<section class="home-how-works">
				<div class="money rellax animated fadeInUp delay-2s"><img src="<?php echo get_theme_file_uri();?>/assets/images/money.svg" class="svg img-fluid" alt=""></div>
				<div class="container">
					<div class="row">
						<div class="col-12">
							...
							<div class="media with-note radius">
								<a href="https://www.youtube.com/watch?v=QANXeDqOo5U" class="popup-video" data-effect="mfp-move-from-top vertical-middle">
									<img src="<?php echo get_theme_file_uri();?>/assets/images/video-cover.jpg" class="img-fluid" alt="">
									<h5 class="note"><span>Spendebt Overview</span> Runtime: 30 Seconds</h5>
								</a>
							</div>
						</div>
					</div>
